...
Write-Host "1. Install .Net Core" -ForegroundColor Cyan

$wc2 = New-Object System.Net.WebClient
$wc2.DownloadFile("https://dot.net/v1/dotnet-install.ps1", "$(Get-Location)\dotnet-install.ps1")
$Command2 = "./dotnet-install.ps1 -Channel LTS"
